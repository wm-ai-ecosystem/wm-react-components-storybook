...
<wm-tile class="bg-default" name="tile" variant="default:default">
  <wm-container height="100%" direction="row" width="fill" alignment="top-left" 
  padding="8" name="container1" class="app-container-default" variant="default">
    <wm-container direction="row" alignment="top-center"padding="8px"
      width="25%" height="fill" name="container2" class="app-container-default" variant="default">
      <wm-icon name="tileIcon" iconclass="wi wi-bar-chart fa-3x" class="fa-xs" 
      variant="default:xs"></wm-icon>
    </wm-container>
...
```javascript
  Page.Widgets.tile.class = "bg-info";
```
...
```javascript
Page.tileClick = function ($event, widget) {
