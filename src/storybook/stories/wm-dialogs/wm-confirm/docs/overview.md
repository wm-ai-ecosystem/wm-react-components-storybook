...
- Optional icon customization for visual emphasis
- Flexible event handling for confirmation, cancellation, and closing actions
- Clean, accessible interface for critical user decisions