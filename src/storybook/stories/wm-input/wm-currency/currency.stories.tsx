...
export const MultipleCurrencies: Story = {
  render: () => {
    const currencies = [
      { code: "USD", name: "US Dollar", value: 1000 },
      { code: "EUR", name: "Euro", value: 850 },
      { code: "GBP", name: "British Pound", value: 725 },
      { code: "JPY", name: "Japanese Yen", value: 110000 },
      { code: "INR", name: "Indian Rupee", value: 75000 },
      { code: "AUD", name: "Australian Dollar", value: 1350 },
    ];
          ...
          {currencies.map((currency, index) => (
            <Box key={index}>
              ...
              <CurrencyDefaultExport
                ...
                decimalplaces={currency.code === "JPY" ? 0 : 2}
                listener={mockListener}
              />
            </Box>
          ))}
